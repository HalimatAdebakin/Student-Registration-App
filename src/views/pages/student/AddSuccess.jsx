  ...
  return (
    <div>
      ...
      <div className="mx-auto rounded-2xl p-6 bg-[white] w-[391px] text-center">
        ...
        <div className="border-b-2 pb-8 mt-2 text-[#748181] font-medium text-base">An account have been created for <span className="font-bold text-lg">Hussein Adebakin</span> with the ID number: <span className="font-bold text-lg">HIS/160407054</span></div>
